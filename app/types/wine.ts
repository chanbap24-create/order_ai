...
export type TabId = 'upload' | 'dashboard' | 'new-wine' | 'all-wines' | 'tasting-note' | 'client-analysis' | 'segments' | 'wine-regions' | 'brand-library' | 'company-events' | 'import-forecast' | 'feature-usage' | 'glass-images' | 'parse-stats';
