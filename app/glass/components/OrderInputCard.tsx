...
import { GLASS_COLORS, STORAGE_KEYS } from "../constants";
import {
  inputBaseStyle,
  inputFocusHandlers,
  monoStyle,
...
/**
 * 발주 입력 카드 — 거래처 입력 + 발주 내용 텍스트어리어 + 액션 바(생성/지우기/붙여넣기/자동붙여넣기 토글)
 */
  ...
  return (
    <div style={softCardStyle}>
      ...
      <div
        style={{
          height: 1,
          background: GLASS_COLORS.dividerFaint,
          margin: "16px 0",
        }}
      />
      ...
      <div style={{ display: "flex", gap: 6, marginTop: 14, alignItems: "center" }}>
        ...
        <button
          ...
          style={{
            ...
            color: canClear ? GLASS_COLORS.textMuted : GLASS_COLORS.textDisabled,
            whiteSpace: "nowrap",
          }}
        ...
        <div
          ...
          style={{
            ...
            cursor: loading ? "not-allowed" : "pointer",
            transition: "all 0.25s cubic-bezier(0.4, 0, 0.2, 1)",
            background: hasClipboard ? GLASS_COLORS.primaryBgLight : "transparent",
            color: hasClipboard ? GLASS_COLORS.primary : GLASS_COLORS.textMuted,
            userSelect: "none",
  ...
  return (
    <div
      ...
      style={{
        ...
        userSelect: "none",
        fontSize: 12,
        color: value ? GLASS_COLORS.primary : "var(--gray-400)",
        fontWeight: 500,
      }}
    >
      <div
