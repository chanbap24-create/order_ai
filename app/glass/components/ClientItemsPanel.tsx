...
/**
 * 거래처 품목 보기 — 등록된 품목 목록에서 수량과 함께 발주 텍스트로 추가.
 */
      ...
      {isAdding ? (
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <input
            ...
            style={{
              ...
              padding: "6px 8px",
              borderRadius: 6,
              border: `1px solid ${GLASS_COLORS.neutralBorder}`,
              fontSize: 16,
              textAlign: "center",
            }}
            min="1"
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 12, color: GLASS_COLORS.neutralTextMuted, marginTop: 2 }}>
              품목코드: {item.item_no}
            </div>
          </div>
          <div style={{ fontSize: 20, color: GLASS_COLORS.neutralIcon }}>+</div>
        </div>
      )}
    </div>
  );
