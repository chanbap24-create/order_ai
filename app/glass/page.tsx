                        ...
                        {top3.length > 0 && (
                          ...
                          >
                            ...
                            {top3.map((s: any, sidx: number) => {
                              ...
                              console.log(`[Glass] Item ${s.item_no}: isNewItem=${isNewItem}, supply_price=${s.supply_price}`);
                              ...
                              return (
                                <button
                                  ...
                                  onClick={async () => {
                                    console.log(`[Glass onClick] isNewItem=${isNewItem}, newItemPrices[${idx}]=${newItemPrices[idx]}`);
