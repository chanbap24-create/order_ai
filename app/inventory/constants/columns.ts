...
export const INV_COLUMNS: InvColumnConfig[] = [
  ...
  { key: "bonded_warehouse", label: "보세(용마)", cdvOnly: true },
  { key: "kctc", label: "KCTC", cdvOnly: true },
  { key: "bonded_kctc", label: "보세(KCTC)", cdvOnly: true },
  { key: "yongma_reserve", label: "KCTC블락", cdvOnly: true },
  { key: "yongma_marketing", label: "KCTC마케팅", cdvOnly: true },
  { key: "yongma_sales1", label: "KCTC영업1", cdvOnly: true },
  { key: "yongma_sales2", label: "KCTC영업2", cdvOnly: true },
