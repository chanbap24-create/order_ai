              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 12,
                    borderLeft: `4px solid ${isToday ? "var(--status-danger)" : "#6A1B9A"}`,
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8, flex: 1, minWidth: 0 }}>
                      <span
                        style={{
                          ...
                          padding: "2px 8px",
                          borderRadius: 4,
                          background: isToday ? "var(--status-danger-bg)" : isTomorrow ? "var(--status-warning-bg)" : "#F3E5F5",
                          color: isToday ? "var(--status-danger)" : isTomorrow ? "var(--status-warning)" : "#6A1B9A",
                          fontSize: 11,
                          fontWeight: 700,
                          whiteSpace: "nowrap",
                          flexShrink: 0,
