...
export const statCard: React.CSSProperties = { flex: "1 0 auto", minWidth: 120, padding: "12px 16px" }; // 스탯 스트립 셀(박스 없음 — 공통 문법)
export const statLabel: React.CSSProperties = { fontSize: 12, color: "var(--text-tertiary)", marginBottom: 6 };
export const statValue: React.CSSProperties = { fontSize: 18, fontWeight: 700, letterSpacing: "-0.01em", color: "var(--text-primary)", fontVariantNumeric: "tabular-nums", whiteSpace: "nowrap" };
