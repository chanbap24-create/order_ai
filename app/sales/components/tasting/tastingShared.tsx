...
export const badgeDone: React.CSSProperties = { fontSize: 11, fontWeight: 700, padding: "2px 8px", borderRadius: 999, background: "var(--color-success, #2e7d32)", color: "#fff" };
...
export const dateInput: React.CSSProperties = { fontSize: 13, padding: "6px 8px", borderRadius: 6, border: "1px solid var(--gray-200)", outline: "none" };
export const fw: React.CSSProperties = { display: "flex", flexDirection: "column", gap: 2 };
export const inp: React.CSSProperties = { fontSize: 13, padding: "6px 8px", borderRadius: 6, border: "1px solid var(--gray-200)", outline: "none" };
...
export const card: React.CSSProperties = { background: "#fff", borderRadius: 10, padding: "12px 16px", border: "1px solid var(--gray-200)" };
export const panel: React.CSSProperties = { background: "var(--surface, #fff)", border: "1px solid var(--border-default, #e7e3df)", borderRadius: 10, padding: "14px 18px", marginBottom: 12 };
export const statCard: React.CSSProperties = { background: "var(--surface, #fff)", border: "1px solid var(--border-default, #e7e3df)", borderRadius: 10, padding: "16px 18px" };
...
export const td: React.CSSProperties = { padding: "5px 8px", borderBottom: "1px solid var(--gray-100)", whiteSpace: "nowrap" };
