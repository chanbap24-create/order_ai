...
export type SalesTabId = 'meetings' | 'briefing' | 'shipments' | 'client-list' | 'analysis' | 'ledger' | 'item-ledger' | 'outstanding' | 'alerts' | 'expense';
...
const TABS: { id: SalesTabId; label: string; icon: string }[] = [
  ...
  { id: 'client-list', label: '거래처', icon: 'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75' },
