...
const TYPE_COLORS: Record<string, string> = {
  ...
  'Rosé': '#D4728A', 'Icewine': '#5BA3CF', 'Grappa': '#8B6914', 'Set': '#2E7D32', 'POS Material': '#FF6F00', '자재': '#78909C',
  'Port': '#6B2D5B', '타사제품': '#666',
};
const TYPE_BG: Record<string, string> = {
  'Champagne': 'rgba(196,163,90,0.08)', 'Sparkling': 'rgba(74,144,217,0.08)', 'Red': 'rgba(139,26,26,0.08)', 'White': 'rgba(218,165,32,0.08)',
  'Rosé': 'rgba(212,114,138,0.08)', 'Icewine': 'rgba(91,163,207,0.08)', 'Grappa': 'rgba(139,105,20,0.08)', 'Set': 'rgba(46,125,50,0.08)', 'POS Material': 'rgba(255,111,0,0.08)', '자재': 'rgba(120,144,156,0.08)',
