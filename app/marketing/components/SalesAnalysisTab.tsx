...
const TYPE_COLORS: Record<string, string> = {
  ...
  'Rosé': '#D4728A', 'Icewine': '#5BA3CF', 'Grappa': '#8B6914', 'Port': '#6B2D5B', '타사제품': '#666',
};
const TYPE_BG: Record<string, string> = {
  'Champagne': 'rgba(196,163,90,0.08)', 'Sparkling': 'rgba(74,144,217,0.08)', 'Red': 'rgba(139,26,26,0.08)', 'White': 'rgba(218,165,32,0.08)',
  'Rosé': 'rgba(212,114,138,0.08)', 'Icewine': 'rgba(91,163,207,0.08)', 'Grappa': 'rgba(139,105,20,0.08)', 'Port': 'rgba(107,45,91,0.08)', '타사제품': 'rgba(102,102,102,0.08)',
};
