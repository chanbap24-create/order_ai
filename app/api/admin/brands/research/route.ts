...
export async function POST(req: NextRequest) {
  ...
  const { brand_name_kr, brand_name_en, country, website } = body;
  ...
  try {
    const { result, validation } = await researchBrandWithClaude(brand_name_kr, brand_name_en, country, website);
